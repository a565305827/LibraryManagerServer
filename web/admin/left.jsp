...
<ul>
    <li><a href="borrowing.jsp" target="mainFrame"><i></i>学生借阅管理</a></li>
    <li><a href="${pageContext.request.contextPath }/admin/main.jsp" target="mainFrame"><i></i>书库管理</a></li>
    <li></i><a href="${pageContext.request.contextPath}/AdminManager?action=getListManager&type=2&utype=4" target="mainFrame"><i></i>图书管理员管理</a></li>
</ul>
